<?php
//左侧四个广告
$strSQL = "select opicname,url from layoutpic where id_layout='12' order by id_layoutpic asc" ;
$objDB->Execute($strSQL);
$leftdownadv_QJ=$objDB->getrows();

//热销商品
$strSQL = "select opicname,url from layoutpic where id_layout='13' order by id_layoutpic asc" ;
$objDB->Execute($strSQL);
...
<div id="hot_product">  
<div id="hot_producttitle">热销商品</div>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
  <tr>
    ...
    <td><a href="msnim:chat?contact=chiantealand@hotmail.com" class="link_navi_qqmsn">MSN联系</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><a href="tencent://message/?uin=1821200979&amp;Site=ty-sh.com&amp;Menu=yes" class="link_navi_qqmsn">QQ联系1</a></td>
    ...
    <td><a href="tencent://message/?uin=2504298444&amp;Site=ty-sh.com&amp;Menu=yes" class="link_navi_qqmsn">QQ联系2</a></td>
    </tr>
</table>
