...
if(isset($action) && $action=="02" && $onuserperm_addprem=='1'){
	...
	$strSQL="INSERT INTO productinfo(title,content,id_proddir,indate,intro,tag,price) 

	                     values('$newstitle','$newscontent','$select2',now(),'$newsintro','$newstag','$price')";
...
if(isset($action) && substr($action,0,2)=="04" && $onuserperm_editprem=='1'){
    ...
    $strSQL="UPDATE productinfo SET title='$newstitle',content='$newscontent',id_proddir='$select2',modate=now(),intro='$newsintro',tag='$newstag',price='$price',buynum='$buynum',ordernum='$ordernum' where id_prodinfo=$oneproductinfoid";
          ...
          <td align="center"><table width="93%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td valign="top" bgcolor="#FFFFFF">产品价格</td>
                    <td bgcolor="#FFFFFF"><input name="price" type="text" class="input_01" /></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
...
<?php  }}?>
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td valign="top" bgcolor="#FFFFFF">产品价格</td>
                    <td bgcolor="#FFFFFF"><input name="price" type="text" class="input_01" value="<?php echo $oneproductinfo[price];?>" /></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td valign="top" bgcolor="#FFFFFF">购买数量</td>
                    <td bgcolor="#FFFFFF"><input name="buynum" type="text" class="input_01" value="<?php echo $oneproductinfo[buynum];?>" /></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td valign="top" bgcolor="#FFFFFF">商品顺序</td>
                    <td bgcolor="#FFFFFF"><input name="ordernum" type="text" class="input_01" value="<?php echo $oneproductinfo[ordernum];?>" /></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
