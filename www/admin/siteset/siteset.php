...
if(isset($_POST[button_ok]) && $onuserperm_editprem=='1'){//修改
	...
	smailboxpass='".$_POST[smailboxpass]."',icp='".$_POST[icp]."',mapcode='".$_POST[mapcode]."',iscopy='".$_POST[iscopy]."' where id_siteset='1'";
	$objDB->Execute($strSQL);
...
否                                        </tr>
                  ...
                  <tr>
                    <td height="30" align="left" valign="middle">国内邮费</td>
                    ...
                    <td colspan="3" align="left" valign="middle" bgcolor="#EBF3F9"  style="padding:0; height:1px;"></td>
                                    ...
                                    <tr>
                                      <td height="30" align="left" valign="middle">海外邮费</td>
