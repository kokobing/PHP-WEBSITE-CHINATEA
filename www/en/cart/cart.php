...
function delep(pid,ploc){
	...
	window.location = "/en/cart/cart.php?act=del&dpid="+pid+"&ploc="+ploc+"&sl="+sl;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="90%" align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center" valign="top"><img src="/inc/pics/icon012en.gif" width="700" height="32" /></td>
            </tr>
            <tr>
            <td colspan="3" style="padding:0; height:10px;" ></td>
            </tr>
              ...
              <td align="center" valign="middle"><div  id="cart_boder_02">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="95%" align="left" class="txt">Into the shopping cart items:</td>
                  </tr>
                  <tr>
                    <td height="1" colspan="2" align="center" valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td bgcolor="#D1D1D1"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1D1D1">
                            <tr>
                              <td width="14%" height="30" align="center" bgcolor="#FFFFFF" class="txt_black"><strong>Photo</strong></td>
                              <td width="20%" align="center" bgcolor="#FFFFFF" class="txt_black"><strong>Product Name</strong></td>
                              <td width="11%" align="center" bgcolor="#FFFFFF" class="txt_black"><strong>Selling price</strong></td>
                              <td width="11%" align="center" bgcolor="#FFFFFF" class="txt_black"><strong>Member Price</strong></td>
                              <td width="11%" align="center" bgcolor="#FFFFFF" class="txt_black"><strong>Quantity</strong></td>
                              <td width="11%" align="center" bgcolor="#FFFFFF" class="txt_black"><strong>Subtotal</strong></td>
					   ...
					   ?>
                            <tr>
                              ...
                              <td align="center" bgcolor="#FFFFFF"><a href="javascript:void(0)" class="link_navi_1"  onclick="delep(<?=$allpid[$i];?>,<?=$i;?>);">Delete</a></td>
                            </tr>
                            <? }else{
							       continue;    
							   }
                                ...
                                <td height="30" align="right" bgcolor="#FFFFFF">
                                  <table width="220" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      ...
                                      <span class="txt">Total paypal payment：$</span></td>
                                ...
                                <td height="30" align="right" bgcolor="#FFFFFF"><table width="220" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="174" align="right"><input name="payfangshi" type="radio" value="2" />
                                      <span class="txt">Total paid in cash：$</span></td>
            ...
            <tr>
              <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="13%" align="center"><input type="button" name="button" id="button" onClick="location.href='/en/index.php?pdir1=<?=$_SESSION["id"]?>&page=<?=$_SESSION["page"]?>'" value="Continue Shopping" /></td>
                  <td width="76%">&nbsp;</td>
                  <td width="11%" align="center"><input type="submit" name="button2" id="button2" value="Checkout" /></td>
                </tr>
              </table></td>
              </tr>
              </form>
