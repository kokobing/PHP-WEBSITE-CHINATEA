...
$strSQL = "select a.title,a.intro,a.content,a.id_prodinfo,a.price,a.buynum,a.id_proddir,a.ordernum,c.fatherid from productinfo as a 
		  left join productdir as c on a.id_proddir=c.id_proddir
		  where a.dele='1' and c.lang='0' order by a.ordernum desc" ;
...
$strSQL = "select a.title,a.intro,a.content,a.id_prodinfo,a.price,a.buynum,a.id_proddir,a.ordernum,c.fatherid from productinfo as a 
		   left join productdir as c on a.id_proddir=c.id_proddir
		   where c.fatherid='".$_GET[pdir1]."' and a.dele=1 and c.lang='0' order by a.ordernum desc" ;
$objDB->SelectLimit($strSQL,$intRows,$intStartNum);
$arrprods=$objDB->GetRows();
...
<div id="picmenu"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <form method=post  name="reg" action="/member/login.php?act=login">
                          <tr>
                            <td height="30" colspan="3" align="left" valign="middle" class="txt">&nbsp;&nbsp;会员中心</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td height="30" align="left"><input type="image" name="imageField2" src="inc/pics/btn_login.gif" style="border:0px none; background:none;" /></td>
                            <td height="30" align="left">&nbsp;</td>
                          </tr>
...
<div id="txtmenu" style="position: absolute; z-index:2;top:150px;width:100%;height:28px; line-height:28px; background-color:#000; text-align:right;filter:alpha(opacity=60); opacity:0.6; color:#FFFFFF;font-size: 12px;"><a href="/member/reg.php">● 用户注册</a>&nbsp;&nbsp;<a href="/member/login.php">● 登陆网站</a>&nbsp;&nbsp;</div>
</div>
<? }?>
...
<p><?=$arrprods[$i][intro];?></p>
</div>
<div id="mainc_rightboxrtopmore" style="margin-top:10px;"><a href="productsinfo.php?pid=<?=$arrprods[$i][id_prodinfo];?>&pdir1=<?=$arrprods[$i][fatherid];?>"><img src="inc/pics/detail.jpg" /></a></div>
</div>
<div id="mainc_rightboxrend">
<div id="mainc_rightboxrendtitle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="27%"><img src="inc/pics/price.jpg" /></td>
    <td width="28%" align="left" class="txt_black2">¥<?=$arrprods[$i][price];?>元</td>
    <td width="27%"><img src="inc/pics/buyrec.jpg" /></td>
    <td width="18%" align="left" class="txt_black2"><?=$arrprods[$i][buynum];?></td>
  </tr>
</table>

</div>
<div id="mainc_rightboxrendmore"><a href="/cart/cart.php?pid=<?=$arrprods[$i][id_prodinfo];?>&pdir1=<?=$arrprods[$i][fatherid];?>"><img src="inc/pics/buy.jpg" /></a></div>
</div>
