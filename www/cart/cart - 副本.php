                            ...
                            <tr>
                              ...
                              <td align="center" bgcolor="#FFFFFF">
                                <table width="28" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="10" rowspan="2"><input  name="aumont<?=$i;?>" type="text" class="input_01"  style="width:20px;" value="1" maxlength="2" id="dj<?=$i;?>" readonly="readonly" /></td>
                              ...
                              <td align="center" bgcolor="#FFFFFF"><div class="txt3" id="xj<?=$i;?>"><?=round($sproduct[price]*$payzhekou_on,2)?></div></td>
                              <td align="center" bgcolor="#FFFFFF"><a href="cart.php?act=del&dpid=<?=$allpid[$i];?>" class="link_navi_1">删除</a></td>
                            </tr>
                            <? }else{
							       continue;    
							   }
