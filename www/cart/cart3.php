...
header("Location:/cart/cart3.php?act=orderined");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="90%" align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
          ...
          <? if($arrOrder[s212_01_07]==1){?>
            <form action="alipay/index.php" method=post  name="reg" onSubmit="return CheckForm(this);"  target="_blank">
              ...
              <input type="hidden" name="payaddr"  id="payaddr" value="<?=$arrOrder[s212_01_02];?>">
              <input type="hidden" name="paymobi"  id="paymobi" value="<?=$arrOrder[s212_01_04];?>">
              <input type="hidden" name="paytel"  id="paytel" value="<?=$arrOrder[s212_01_05];?>">
            <tr>
            ...
            <tr>
              <td align="center" valign="middle"><div  id="cart_boder_02">
                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" align="left" class="txt">您的订单已经提交</td>
                  </tr>
                  <tr>
                    <td height="30" align="left" class="txt"> 订单编号为：<?=$arrOrder[s212_01_01];?></td>
                  </tr>
                  <tr>
                    <td height="30" align="left" class="txt">支付方式：<? if($arrOrder[s212_01_07]==1){echo '支付宝';} if($arrOrder[s212_01_07]==2){echo '快钱';}?></td>
                  </tr>
                  <tr>
                    <td height="30" align="left" class="txt">总金额：<?=$arrOrder[s212_01_10];?></td>
                    </tr>
                  <tr>
                    <td height="1" align="center" valign="top"><input type="submit" name="button" id="button" value="立即付款" style="width:100px; height:40px;" />
                      <br /></td>
                  </tr>
                </table>
              </div></td>
            ...
            <tr>
              <td align="center" valign="middle"><div  id="cart_boder_02">
                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="1" align="center" valign="top"><form action="https://www.sandbox.paypal.com/cgi-bin/websrc" method="post">
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="chinateaisland@hotmail.com">
            ...
            <tr>
              <td align="center" valign="middle"><div  id="cart_boder_02">
                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="30" align="left" class="txt">支付方式: 线下现金转帐</td>
                  </tr>
                  <tr>
                    <td height="30" align="left" class="txt">总金额：<?=$arrOrder[s212_01_10];?></td>
                    </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center" valign="middle"><div  id="cart_boder_02">
                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" align="center" class="txt3">您的订单已经已经完成支付</td>
                  </tr>
                  <tr>
                    <td height="30" align="left" class="txt"> 订单编号为：<?=$arrOrder[s212_01_01];?></td>
                  </tr>
