...
$out_trade_no		= $_POST['subject'];		//请与贵网站订单系统中的唯一订单号匹配

$subject			= $_POST['subject'];	//订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。

$body				= $_POST['subject'];	//订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
...
$receive_name		= $_POST['payname'];			//收货人姓名，如：张三

$receive_address	= $_POST['payaddr'];			//收货人地址，如：XX省XXX市XXX区XXX路XXX小区XXX栋XXX单元XXX号

$receive_zip		= "123456";				//收货人邮编，如：123456

$receive_phone		= $_POST['paytel'];		//收货人电话号码，如：0571-81234567

$receive_mobile		= $_POST['paymobi'];		//收货人手机号码，如：13312341234



//网站商品的展示地址，不允许加?id=123这类自定义参数

$show_url			= "http://www.chinatealand.com/index.php";
