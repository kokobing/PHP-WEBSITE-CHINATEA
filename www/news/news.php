...
$intRows = 26;
$strSQLNum = "SELECT COUNT(*) as num from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where a.dele=1 and b.fatherid=1 and b.lang='0'";   
...
$strSQL = "select a.*,b.fatherid from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where a.dele=1 and b.fatherid=1 and b.lang='0' order by a.id_newsinfo desc" ;
